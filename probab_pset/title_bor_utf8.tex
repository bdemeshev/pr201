...
\pgfplotsset{compat = 1.8} % чтобы использовать преимущества новой версии
...
\embedfile[desc={title bor}]{title_bor_utf8.tex}
\embedfile[desc={prob and sol}]{prob_and_sol_utf8.tex}
% тут еще добавить все главы!!!
