...
\input{chapters/010_simple_experiments.tex}
\input{chapters/020_complex_experiments.tex}
\input{chapters/030_conditional_p_e.tex}
\input{chapters/040_variance.tex}
\input{chapters/050_dependent_variables.tex}
\input{chapters/060_solution_techniques.tex}

\input{chapters/070_inequalities.tex}
% сюда же сходимости не считая цпт

\input{chapters/080_computer_exercises.tex}
\input{chapters/090_poisson_process.tex}
\input{chapters/100_normal_clt.tex}
\input{chapters/110_brownian_motion.tex}
