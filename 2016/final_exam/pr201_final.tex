...
\noindent{\bf Теория вероятностей и математическая статистика  \hfill Экзамен, 19.06.2017}
...
\copygroup[6]{prob_kolya}{all}


\copygroup[8]{prob_borya}{all}

\copygroup[6]{prob_dima}{all}

\copygroup[5]{prob_ivan}{all}

\copygroup[5]{prob_ev}{all}
