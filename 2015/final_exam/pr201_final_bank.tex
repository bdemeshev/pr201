...
\section{Про одну выборку}

\cleargroup{all}

\shufflegroup{prob_one_sample}
\copygroup[9]{prob_one_sample}{all}

\insertgroup{all}


\section{Про две выборки}

\cleargroup{all}

\shufflegroup{prob_two_samples}
\copygroup[8]{prob_two_samples}{all}

\insertgroup{all}


\section{Про выборочные характеристики}

\cleargroup{all}

\shufflegroup{prob_sample_char}
\copygroup[10]{prob_sample_char}{all}
...
\shufflegroup{prob_estimators}
\copygroup[8]{prob_estimators}{all}
...
\shufflegroup{prob_ml_mm}
\copygroup[10]{prob_ml_mm}{all}
